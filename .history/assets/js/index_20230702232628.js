...
buscarButton.addEventListener('click', function () {
  ...
  if (cuartosInput === '' || metrosDesdeInput === '' || metrosHastaInput === '') {
    ...
    const propiedadesFiltradas = propiedadesJSONOriginal.filter(propiedad =>
    ...
    document.getElementById('totalPropiedades').textContent = propiedadesFiltradas.length;
...
limpiarButton.addEventListener('click', function () {
  ...
  document.getElementById('totalPropiedades').textContent = propiedadesJSONOriginal.length;
});